...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('problem', '0054_auto_20200225_1551'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='otv',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='imgs', to='problem.Answer', verbose_name='Ответ'),
        ),
        migrations.AlterField(
            model_name='problem',
            name='parsing',
        ...
        migrations.AlterField(
            ...
            name='dep',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='problem.Department', verbose_name='Отдел'),
        ),
    ]
